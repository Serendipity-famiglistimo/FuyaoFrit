...
#        
#        self.layout.AddRow(self.top_btn, None)
#        self.layout.AddRow(self.flip_check4, None)
#        self.layout.AddRow(self.is_pick_label4, None)
#        
#        self.layout.AddRow(self.bottom_btn, None)
#        self.layout.AddRow(self.flip_check5, None)
#        self.layout.AddRow(self.is_pick_label5, None)
#        
#        self.layout.AddRow(self.bottom1_btn, None)
#        self.layout.AddRow(self.flip_check6, None)
#        self.layout.AddRow(self.is_pick_label6, None)
